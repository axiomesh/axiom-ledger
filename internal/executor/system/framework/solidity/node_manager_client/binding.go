...
func (_BindingContract *BindingContractTransactor) Register(opts *bind.TransactOpts, info NodeInfo) (*types.Transaction, error) {
	return _BindingContract.contract.Transact(opts, "register", info)
}

// Register is a paid mutator transaction binding the contract method 0x49514a6b.
//
// Solidity: function register((uint64,string,string,string,address,(string,string,string,string),uint8) info) returns(uint64 nodeID)
func (_BindingContract *BindingContractSession) Register(info NodeInfo) (*types.Transaction, error) {
	return _BindingContract.Contract.Register(&_BindingContract.TransactOpts, info)
}

// Register is a paid mutator transaction binding the contract method 0x49514a6b.
//
// Solidity: function register((uint64,string,string,string,address,(string,string,string,string),uint8) info) returns(uint64 nodeID)
func (_BindingContract *BindingContractTransactorSession) Register(info NodeInfo) (*types.Transaction, error) {
	return _BindingContract.Contract.Register(&_BindingContract.TransactOpts, info)
}
